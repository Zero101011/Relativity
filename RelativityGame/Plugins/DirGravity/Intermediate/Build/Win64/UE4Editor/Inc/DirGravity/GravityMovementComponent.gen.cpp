...
// Cross Module References
	...
	DIRGRAVITY_API UFunction* Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	DIRGRAVITY_API UFunction* Z_Construct_UFunction_UGravityMovementComponent_SetGravityDirection();
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGravityMovementComponent, nullptr, "GetGravityDirection", sizeof(GravityMovementComponent_eventGetGravityDirection_Parms), Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54880400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGravityMovementComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGravityMovementComponent_GetGravityDirection, "GetGravityDirection" }, // 4032082488
		{ &Z_Construct_UFunction_UGravityMovementComponent_SetGravityDirection, "SetGravityDirection" }, // 802073345
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGravityMovementComponent_Statics::NewProp_CustomGravityDirection = { "CustomGravityDirection", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGravityMovementComponent, CustomGravityDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UGravityMovementComponent_Statics::NewProp_CustomGravityDirection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGravityMovementComponent_Statics::NewProp_CustomGravityDirection_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGravityMovementComponent_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UGravityMovementComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UGravityMovementComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UGravityMovementComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UGravityMovementComponent, 685783897);
